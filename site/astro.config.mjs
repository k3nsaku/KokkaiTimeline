...
/**
 * 完全静的サイト（`output: "static"`）。サーバは持たない — CLAUDE.md の絶対制約。
 *
 * 発言の中身は sql.js-httpvfs がブラウザから HTTP Range で期間DBを引く。
 ...
 * `Access-Control-Expose-Headers: content-range`）が要る。設定は docs/PIPELINE.md。
 */
